            ...
            <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r xl:w-full p-4 flex flex-col justify-between leading-normal">
              <div class="mb-auto">
                ...
                <p class="text-gray-700 text-base">
                  The only way to start your day. Delectable breakfast served
                  with steaming coffee is what it’s about at The Marikina Hotel.
                  Served in The Iris, take your pick from the sumptuous buffet.
                  And for those of you who crave a little longer in bed, dial up
                  room service and have breakfast brought directly to your room.
                </p>
              </div>
              <div class="flex items-center">
                <div class="text-sm">
                  <p class="text-gray-900 leading-none">
                    From 7am to 10am during the week, until 10:30am on Saturday
                    and Sunday.
                  </p>
          ...
          <div class=" w-full lg:max-w-full lg:flex md:flex">
            ...
            <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r xl:w-full p-4 flex flex-col justify-between leading-normal">
              <div class="mb-auto">
                ...
                <p class="text-gray-700 text-base">
                  Food cravings call on you at all hours of the day, which is
                  why The Hotel offers you exceptional room service, 24/7.
                  Whether it’s breakfast in bed or a midnight snack on your
                  mind, just make that call and let The Hotel bring you all
                  things delicious.
                </p>
              </div>
              <div class="flex items-center">
          ...
          <div class=" w-full lg:max-w-full lg:flex md:flex">
            ...
            <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r xl:w-full p-4 flex flex-col justify-between leading-normal">
              <div class="mb-auto">
                ...
                <p class="text-gray-700 text-base">
                  Our spacious state-of-the-art fitness center is exclusive for
                  our guests, offering free weights, circuit training,
                  cardiovascular equipment and power plate machines.
                </p>
              </div>
              <div class="flex items-center">
                <div class="text-sm">
                  <p class="text-gray-900 leading-none">
                    From 6am to 11am and 1pm to 9pm everyday
                  </p>
                  <p class="text-gray-600">Thank You.</p>
                </div>
              </div>
