              ...
              <div className="flex xl:flex-row">
                <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                  ...
                  <p className="max-w-xl mb-4 text-base text-white md:text-lg">
                    ...
                    Whether it is for a conference, a meeting or a private
                    event, Marikina Hotel wishes to offer you the best service
                    you can ask for. The success of your event is our pride.
                    With hundreds of square meters of flexible meeting space,
                    and a selection of function rooms designed for comfort and
                    benefiting from natural sunlight, your event will be a
                    success. Technological efficiency is the hallmark of our
                    Meeting Rooms, boasting leading-edge equipment such as the
                    latest audiovisual and technological resources,
                    sophisticated projection and sound systems.
                  </p>
                </div>
              </div>
            </div>
